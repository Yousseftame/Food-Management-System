...
export default function dashboard() {
  ...
  return (
    <>
    <Header title={" Welcome "} title2={'youssef1  !'} description={'This is a welcoming screen for the entry of the application , you can now see the options'} imgPath={dashboardPic} />
